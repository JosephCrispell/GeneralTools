...
scotland$NumberConfirmedCases <- as.numeric(cases[nrow(cases), as.character(scotland$HBName)])
...
labels <- sprintf(
  ...
  scotland$HBName, scotland$NumberConfirmedCases) %>% lapply(htmltools::HTML)
