...
folderName <- paste("4Demes_", type, "PopSizes_07-02-17/", sep="")

file <- paste(path, folderName,
              "4Demes_", type, "PopSizes_07-02-17.log", sep="")
...
barplot(rootStateCounts, yaxt="n", names=c("innerBadger", "innerCow", "outerCow", "outerBadger"),
