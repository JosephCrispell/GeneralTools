...
# Remove Mislabelled cattle
######

geneticVsEpi <- geneticVsEpi[geneticVsEpi$IsolateI %in% c("TB1800", "TB1806", "TB1807") == FALSE, ]
geneticVsEpi <- geneticVsEpi[geneticVsEpi$IsolateJ %in% c("TB1800", "TB1806", "TB1807") == FALSE, ]


######

# Open a PDF
file <- paste(path, "ExamineEpiVariableCorrelation_", selection, "_26-05-17.pdf", sep="")
