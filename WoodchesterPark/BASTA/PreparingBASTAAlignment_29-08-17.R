...
assignIsolatesToDemes <- function(demeStructure, isolateInfo, innerThreshold, badgerCentre){
  ...
  # 5 Deme structures defined:
  #   No.     No. Demes   Deme names
  #   1       3           innerBadger, innerCow, outer
  #   2       3           innerBadger, cattle, outerBadger (U)
  #   3       4           innerBadger, innerCow, outerCow, outerBadger (U)
  #   4       6           innerBadger, innerCow, outerCowEast, outerCowWest, 
  #                       outerBadgerEast (U), outerBadgerWest (U)
  #   5       8           innerBadgerEast, innerBadgerWest, innerCowEast, innerCowWest
  #                       outerCowEast, outerCowWest, outerBadgerEast (U), outerBadgerWest (U)
