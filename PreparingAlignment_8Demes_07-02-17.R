...
# Open a PDF
file <- paste(path, "BASTA/DefinedDemes_8Demes_", date, ".pdf", sep="")
pdf(file)
...
# Define demes
# A - Inner East of centre
# B - Inner West of centre
# C - Outer East of centre
# D - Outer West of centre
...
# Open an output file
fileName <- paste(path, "BASTA/", "xmlInput_8Demes_", date, ".xml", sep="")
